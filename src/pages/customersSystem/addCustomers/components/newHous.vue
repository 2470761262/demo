<template>
  <div>
    <div class="hous-conten mar-top">
      ...
      <!-- 交房类型 -->
      <div class="input-group">
        <div class="input-head">交房类型</div>
        <el-select
          v-model="data.tradeHouseType"
          popper-class="options-item"
          class="input-content"
          placeholder="请选择交房类型"
        >
          <el-option
            v-for="item in tradeHouseTypeList"
            :key="item.value"
            :label="item.key"
            :value="item.value"
          ></el-option>
      ...
      <!-- 物业类型 -->
      <div class="input-group">
        <div class="input-head">物业类型</div>
        <el-select
          v-model="data.manageCompanyType"
          popper-class="options-item"
          class="input-content"
          placeholder="请选择物业类型"
        >
          <el-option
            v-for="item in manageCompanyTypeList"
            :key="item.key"
            :label="item.value"
            :value="item.key"
          ></el-option>
...
export default {
  ...
  data() {
    return {
      ...
      manageCompanyTypeList: manageCompanyTypeList,
