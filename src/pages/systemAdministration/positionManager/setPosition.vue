      ...
      <div class="elTree">
        <el-tree :data="ruleTreeData"
          ...
          <span class="custom-tree-node" slot-scope="{ node, data }">
            ...
            <span>
              <el-button type="text" size="mini" @click.stop="() => operationSelf(node,data)"> 自己</el-button>
              <el-button type="text" size="mini" @click.stop="() => operationDept(node, data)"> 部门权限</el-button>
              <el-button type="text" size="mini" @click.stop="() => operationCompany(node, data)">跨部门权限</el-button>
            </span>
          </span>
        </el-tree>
      </div>
