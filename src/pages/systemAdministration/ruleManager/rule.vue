  ...
  <div>
    <template>
      <div class="elTree">
        ...
        关键字:
        <el-input style="width: 200px;" placeholder="输入关键字进行过滤" @change="keywordChange" v-model="keyword"></el-input>
        类型:
    ...
    <template>
      <el-card class="box-card">
        <div class="text item">
          ...
          <div class="formItem">
            <el-button type="primary" @click="saveSiblingRule">添加同级子节点</el-button>
          </div>
          <div class="formItem">
