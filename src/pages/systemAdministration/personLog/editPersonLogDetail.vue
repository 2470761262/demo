...
<template>
  <div class="wrapper">
      ...
      <el-form ref="form" :model="personLogEntity" label-width="80px" :inline="true">
       <el-form-item label="操作人:">
        ...
        <el-form-item label="变动时间">
          <el-input v-model="personLogEntity.logDate" readonly="readonly">
          </el-input>
        </el-form-item>
      </el-form>    
      <el-form ref="form" :model="personLogEntity" label-width="80px" :inline="true">
        ...
        <el-form-item label="审核状态">
          <el-input v-model="personLogEntity.tag" readonly="readonly">
          </el-input>
        </el-form-item>
      </el-form>
      <el-form ref="form" :model="personLogEntity" label-width="80px" :inline="true">
        ...
        <el-form-item label="审核时间">
          <el-input v-model="personLogEntity.checkTime" readonly="readonly">
          </el-input>
        </el-form-item>
      </el-form>     
    </div>
        <template>
          <el-table
            ...
            border
            style="width: 100%">
            <el-table-column v-for="item in tableDataColumn" :prop="item.prop"
                               :label="item.label"
                               :width="item.width"
                               :key="item.prop">
                    </el-table-column>
    ...
    <div class="footerContainer el-top">
      <el-button type="primary" @click="savepersonLog()">通过</el-button>
      <el-button type="primary" @click="back()">不通过</el-button>
    </div>
  </div>
</template>
