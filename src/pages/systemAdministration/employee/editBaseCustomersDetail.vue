<template>
     <div class="wrapper">
      <el-form ref="form" :model="customersEntity" label-width="80px" :inline="true">
        <el-form-item label="姓名:" >
          <el-input v-model="customersEntity.customerName" readonly="readonly"></el-input>
        </el-form-item>
      ...
      <el-form ref="form" :model="customersEntity" label-width="80px" :inline="true">
       <el-form-item label="常用电话:">
          <el-input v-model="customersEntity.commonTel" readonly="readonly"></el-input>
        </el-form-item>
      ...
      <el-form ref="form" :model="customersEntity" label-width="80px" :inline="true">
        <el-form-item label="工作:">
          <el-input v-model="customersEntity.customerJob" readonly="readonly"></el-input>
        </el-form-item>
      ...
      <el-form ref="form" :model="customersEntity" label-width="80px" :inline="true">
        <el-form-item label="添加人:">
          <el-input v-model="customersEntity.addName" readonly="readonly"></el-input>
        </el-form-item>
      ...
      <el-form ref="form" :model="customersEntity" label-width="80px" :inline="true">
       ...
       <el-form ref="form" :model="customersEntity" label-width="80px" :inline="true">
        <el-form-item label="备用电话:">
          <el-input v-model="customersEntity.spareTel" readonly="readonly"></el-input>
        </el-form-item>
        <el-form-item label="备用电话">
