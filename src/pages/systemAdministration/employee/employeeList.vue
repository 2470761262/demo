      ...
      <template v-slot:top>
        <div class="query-cell">
          ...
          <el-button type="primary"
                     style="margin-left:10px"
                     size="mini"
                     @click="queryEmployeeByIsLocked(0)">查询锁定用户</el-button>
          <el-button type="primary"
                     style="margin-left:10px"
                     size="mini"
                     @click="queryEmployeeByIsLocked(1)">查询正常用户</el-button>
          <el-button type="primary"
                     style="margin-left:10px"
                     size="mini"
                     @click="queryEmployeeByIsLocked(2)">查询异常用户</el-button>
          <el-button type="primary"
                     style="margin-left:10px"
                     size="mini"
                     @click="queryEmployeeByDel(0)">查询在职用户</el-button>
          <el-button type="primary"
                     style="margin-left:10px"
                     size="mini"
                     @click="queryEmployeeByDel(1)">查询离职用户</el-button>
          <el-button type="primary"
                     style="margin-left:10px"
                     size="mini"
                     @click="queryEmployeeByDel(2)">查询待离职用户</el-button>
    ...
    <el-dialog title="提示"
      ...
      <div class="left-input-container">
        ...
        <el-input type="date"
                  ...
                  v-model="employeeEntity.leaveTime"></el-input>
        <span>离职原因</span>
        <el-input type="text"
                  placeholder="请输入内容"
