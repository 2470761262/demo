    ...
    <list-page :parentData="$data"
      ...
      <template v-slot:top>
        <div class="query-cell">
          ...
          <el-button type="primary" style="margin-left:10px" size="mini" @click="queryEmployee()">查询</el-button>
          <el-button type="primary" style="margin-left:10px" size="mini" @click="cancel()">返回</el-button>
        </div>
      </template>
        ...
        <el-table-column prop="operation" label="操作" fixed="right" key="operation">
          <template v-slot="scope">
            <div v-if="scope.row.operation!=''">
              <el-button type="info" size="mini" @click="setAuthority(scope.row)" >权限设置</el-button>
            </div>
          </template>
        </el-table-column>
