...
<template>
  <section>
    <div class="page-button-group">
      ...
      <!-- 总监推荐 -->
      <div class="button-set">
        <el-button :disabled="isDisabled" @click="nodePop" v-if="!isRecommend">
      ...
      <!-- 锁定房源 -->
      <div class="button-set">
        <el-button :disabled="isDisabled" v-if="isShowButton.locking" @click="houseLock">
          <i
      ...
      <div class="button-set" v-if="resultData.agentHouseMethod">
        <el-button
          :disabled="isDisabled||!(resultData.keyOwner>0)"
    ...
    <!-- 转房源状态 -->
    <changeHouseType title :visible.sync="typeFlag" width="580px" maskHideEvent v-if="typeFlag"></changeHouseType>
    <!-- 取消作业方 -->
    <cancelTask
      title
