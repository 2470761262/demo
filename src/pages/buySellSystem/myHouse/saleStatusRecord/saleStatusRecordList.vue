    ...
    <div class="list-right">
      <div class="scroll-tab">
        <el-table
          ...
          :default-sort="{ prop: 'checkTime', order: 'ascending' }"
        >
          <el-table-column
...
export default {
  ...
  methods: {
    ...
    getTree() {
      ...
      this.$api
        .post({
          url: "/static/sale/status/records",
          data: {
            tree: "1"
          },
    ...
    getHouseData(value, initPage = true) {
      ...
      let url = "/static/sale/status/records";
      ...
      if (restuleParms.time && restuleParms.time.length == 2) {
        restuleParms.minCheckTime = restuleParms.time[0];
        restuleParms.maxCheckTime = restuleParms.time[1];
      }
      restuleParms.treeCompany = this.treeCondition[0];
      restuleParms.treeDepartment = this.treeCondition[1];
      restuleParms.treeAccount = this.treeCondition[2];
