  ...
  <div class="flex">
    <div class="msgBox">
      <el-scrollbar style="height:100%;width:1650px">
        <div class="detailBox" style="width:100px;margin-top:1rem;loat: left;">
          <div class="house">
        ...
        <div class="detailBox" v-for="(item, index) in houseList" :key="index">
          <div class="house">
          ...
          <div class="text">
            {{ item.inAroomsrea == null ? "" : item.inAroomsrea + "室"
            }}{{ item.hall == null ? "" : item.hall + "厅"
            }}{{ item.kitchen == null ? "" : item.kitchen + "厨"
            }}{{ item.toilet == null ? "" : item.toilet + "卫" }}
          </div>
          <div class="text">
          ...
          <div class="text">
            {{
              item.middleSchoolScribing == null
                ? "暂无"
                : item.middleSchoolScribing
            }}
          </div>
