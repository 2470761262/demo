        ...
        <div class="for-add-table">
          ...
          <div class="for-add-tbody">
            <div
              ...
              :class="{
                'after-tips':
                  errorBags.has('buildingId' + (index + 1)) ||
                  errorBags.has('roomId' + (index + 1)) ||
                  errorBags.has('bottomPrice' + (index + 1))
              }"
              :data-tips="
                errorBags.first('buildingId' + (index + 1)) ||
                  errorBags.first('roomId' + (index + 1)) ||
                  errorBags.first('bottomPrice' + (index + 1))
              "
              ...
              <div class="for-add-td select-nobor">
                ...
                >
                  <el-option
                    ...
                    :key="item.value"
                    :disabled="
                      filterRoomDisabled().includes(
                        tableFor[index].buildingId + '$' + item.value
                      )
                    "
                    :label="item.name"
                    :value="item.value"
        ...
        <div class="page-cell-item select-nobor">
          <el-input
            ...
            v-validate="{
              phone: true,
              isSame: [
                [form.tel, ...addTel.map(tel => form['tel' + tel])],
                '手机号'
              ]
            }"
          >
