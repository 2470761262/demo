export default [
    {
        name: "我的房源", icon: 'iconwodefangyuan iconfont', active: '1', children: [
    ...
    {
        name: "资源库", icon: 'iconzaishouwugendan iconfont', active: '2', children: [
    ...
    {
        name: "全部在售", icon: 'iconzaishouwugendan iconfont', active: '3', children: [
            { name: "全部在售", active: '/buySellSystem/saleAll' }
        ]
    },
    {
        name: "成交房源", icon: 'iconzaishouwugendan iconfont', active: '4', children: [
