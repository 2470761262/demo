  ...
  data () {
    return {
      ...
      tableColumnField: [
        ...
        { prop: 'LastPairFollow', label: '未跟进天数', width: '120', order: 'custom', disabled: false, default: true },
        ...
        { prop: 'roomType', label: '户型', width: '150', order: false, disabled: false, default: true, formart: item => item.rooms + '室' + item.hall + '厅' + item.toilet + '卫' },
        { prop: 'unitpaice', label: '单价(元/㎡)', width: '120', order: 'custom', disabled: false, default: false, format: item => Math.round(item.price * 10000 / item.inArea) + '元/㎡' },
