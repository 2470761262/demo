export default [
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "customersIframe" */ "@/pages/customersSystem/customersIframe/customersIframe.vue"
      ),
    children: [
      {
        //全部私客
        ...
        component: () =>
          import(
            /* webpackChunkName: "allCustomers" */ "@/pages/customersSystem/myCustomers/allCustomers.vue"
          )
      },
      {
        //全部私客
